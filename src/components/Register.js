        ...
        return (
            <div style={styleCss.containerMain}>
                <div style={styleCss.containerContent}>
                    ...
                    <div style={styleCss.containerLeft} class='pt-5 mt-5'>
                    <div style={styleCss.formContainer2} class="card text-white pt-5 col-12">
                        <Form>
                            <Form.Label><h2>Login</h2></Form.Label>
                            <Form.Group className="mb-4" controlId="formBasicName">
                                <Form.Control className='bg-secondary bg-opacity-50' type="text" placeholder="Name" />
                            </Form.Group>
                        ...
                        <Button className='d-grid gap-2 col-12 mx-auto fw-bold text-white' variant="danger" type="submit" onClick={handleNavigateToLogin}>
                            Login
                        </Button>
                        </Form>
                    </div>
